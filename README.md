# Validation_Tool
- Test Locally
1. Clone the repo in the location you want
2. Open terminal and input'python app.py'
3. Wait for page loading and then click the link in the ouput
eg: 'Dash is running on http://127.0.0.1:8050/'

- Test on Databricks
Validation app: https://adb-3893261652776219.19.azuredatabricks.net/apps/validation?o=3893261652776219
